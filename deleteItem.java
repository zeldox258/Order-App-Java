...
public class deleteItem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bar.setModel(new javax.swing.DefaultComboBoxModel<>());
        for(int i = 0;i<Siparis.menu.size();i++){
            bar.addItem(Siparis.menu.get(i));
        }
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        int index = bar.getSelectedIndex();
        if(index == -1){
            JOptionPane.showMessageDialog(null,"There is no item","Error",JOptionPane.ERROR_MESSAGE);
            return;
        }
        Siparis.menuPrices.remove(Siparis.menu.get(index));
        Siparis.menu.remove(index);
